...
async function main(){
    ...
    // flat: transform 2d array into 1d
    cubeVertices = cubeVertices.flat();
...
function draw(){
    ...
    mdlMatrix.setIdentity();
    mdlMatrix.translate(0+0.9*moveDistance,0.15,0);
